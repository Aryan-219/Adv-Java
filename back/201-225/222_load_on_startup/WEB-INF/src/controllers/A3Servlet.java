...
public class A3Servlet extends HttpServlet {
    public void init() throws ServletException {
        System.out.println("------------ 222 load on startup (A3Servlet)---- init");
        System.out.println("------------ 222 load on startup ---- init");
        System.out.println("------------ 222 load on startup ---- init");
    }
    
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        System.out.println("------------ 222 load on startup (A3Servlet) ---- doGet");
        System.out.println("------------ 222 load on startup ---- doGet");
        System.out.println("------------ 222 load on startup ---- doGet");
    }
    
    public void destroy() {
        System.out.println("------------ 222 load on startup (A3Servlet) ---- destroy");
