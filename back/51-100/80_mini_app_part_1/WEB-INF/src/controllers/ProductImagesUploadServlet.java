...
public class ProductImagesUploadServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        ArrayList<Integer> sellerProductImageIds = SellerProductImage.collectProductImageIds(sellerProductId);
        request.setAttribute("seller_product_image_ids", sellerProductImageIds);
                ...
                try {
                    ...
                    for(FileItem fileItem : fileItems) {
                        if(fileItem.isFormField()) {
                            ...
                            imagePaths.add(filePathWithExt);
