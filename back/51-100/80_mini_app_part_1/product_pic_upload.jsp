    ...
    <div id="main_page_body">
        ...
        <div id="main_body">
            ...
            <form action="product_pic_upload.do" method="post" enctype="multipart/form-data">
                ...
                <div id="form_box">
                    <h1><%= request.getParameter("seller_product_name") %></h1>
            ...
            <div>
                <% ArrayList<Integer> sellerProductImageIds = (ArrayList<Integer>)request.getAttribute("seller_product_image_ids"); %>
            
                <% for(Integer imageId : sellerProductImageIds) { %>
                    <img src="product_image.do?seller_product_image_id=<%= imageId %>">
                <% } %>   
            </div>
        </div> 
